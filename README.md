...
flowchart TD
    ...
    F --> F1["Ontology Information:<br/>• Definitions & Synonyms<br/>• Hierarchical Relations<br/>• Cross-references<br/>• Annotations"]
    ...
    I --> I1["• Chosen Entity<br/>• Confidence Scores<br/>• Biological Explanation<br/>• Alternative Candidates"]
