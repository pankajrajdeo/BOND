...
class QueryItem(BaseModel):
    ...
    field_name: Optional[str] = Field(None, description="Context about the field being searched")
    dataset_description: Optional[str] = Field(None, description="Description of the dataset context")
    restrict_to_ontologies: Optional[List[str]] = Field(None, description="List of ontology sources to restrict search to")
...
class BatchRequest(BaseModel):
    """Batch query request containing multiple items"""
    items: List[QueryItem] = Field(..., description="List of queries to process in batch")
